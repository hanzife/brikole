...
$(document).ready(function () {
    ...
    $.ajax({
        url: "/signupBrikoleur_2",
        type: "GET",
        dataType: "json",
        success: function (data) {
            // for (var i in data[0])
            // listProfessions.push([i, data[0][i]]);
            for (var i = 0; i < data[0].length; i++) {
                listProfessions[i] = data[0][i];
            }
            //AJAX INSIDE 
            ...
            //SEARCH BRIKOLUERS
            $('.sb2-continue-P').on("click", function () {
                var profession = selectedPrefession;
                window.location.href = "/signupBrikoleur_3/" + profession;
            });
    ...
    let libelleP = document.getElementById("profession_libelle").value;
    // alert(libilleP);
    $.ajax({
        url: "/signupBrikoleur_3/" + libelleP,
        type: "GET",
        dataType: "json",
        success: function (result) {
            ...
            $('.sb2-continue-SP').on("click", function () {
                // alert(selectedSubPrefessions);
                window.location.href = "/signupBrikoleur_4/" + selectedSubPrefessions;
            });
    ...
    <div>
        ...
        // console.log(result);
        // alert("data[0]");
        // alert("/signupBrikoleur_3/" + libilleP);
        // alert(listSubProfessions);
    ...
    //             //SEARCH BRIKOLUERS
    //             $('.sb2-continue').on("click", function () {
    //                 window.location.href = "/signupBrikoleur_3/" + selectedPrefession
    //             });
    //             //GREEN LIST ON CLICK
