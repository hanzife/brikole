        <link rel="stylesheet" href="{{ asset('css/signupBrikoleur_2.css')}}" />
        <link rel="stylesheet" href="{{ asset('css/signupBrikoleur_4.css')}}" />
...
@section('content')
        ...
        <form  id="uploadimg" action="/portfolio" method="post" enctype="multipart/form-data">   
        @csrf
            ...
            <div class="sb2-container">
                <div class="sb2-sub-container">
                    ...
                    <div class="sb4-section2-text">
                        <div class="sb4-section2-text1">Inscription</div>
                        <div class="sb4-section2-text2">
                    ...
                    <div class="sb4-mainSection">
                
                        <div class="sb4-imageUploadSection">
                            <div class="sb4-imageProfile">
                                <img id="DisplayProfil" src="" alt="" />
                            </div>
                            <div class="sb4-imageUploadButtonSection">
                                <input id="sb4-imageUploadButton" onchange="DisplayImg(this)" type="file" name="image"/>
                                <label for="sb4-imageUploadButton">
                                    Choisire une image
                                    <svg
                                        width="20"
                                        height="20"
                            ...
                            <div class="sb4-imageSize">
                                Taille maximale d'image est 512 Ko
                            </div>
                        </div>
                        <div class="sb2-blank-40"></div>
                        <div class="sb4-section2-text2">
                            Rédiger une biographie a propos de vous
                        </div>
                        <div class="sb4-blank-20"></div>
                        <div class="sb4-seperator2"></div>
                        <textarea
                            class="sb4-commentArea"
                            type="textarea"
                            name="description"
                    ...
                    <div class="sb2-submit">
                        ...
                        <button class="sb2-continue sb2-continue-Img"  value="Submit">
                            Continuer
                            <svg
                                width="7"
                                height="11"
        ...
        ></script>
        <script src="{{asset('js/signupBrikoleur_4.js')}}"></script>
