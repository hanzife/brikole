    ...
    <div class="sb1-container">
        <div class="sb1-sub-container">
            ...
            <div class="sb1-accountType">
                <div class="sb1-accountType-item sb1-accountType-item-active">
                ...
                <div class="sb1-accountType-item">
                    <svg width="45" height="45" viewBox="0 0 46 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="23" cy="22.5" r="22.5" fill="#F7F7F8" />
                        <path
            ...
            <div class="sb1-form">
                ...
                @csrf
                    ...
                    <div class="sb1-cities-list" id="sb1-cities-list">
                        <div class="sb1-city-select" tabindex="0">
                            Safi
                        </div>
                        <div class="sb1-city-select" tabindex="0">
                            Marrakech
                    ...
                    <div class="sb1-submit">
                        <button class="sb1-cancel" name="" id="sb1-cancel">
                            Annuler
                        </button>
                        <div name="" class="sb1-continue" id="sb1-continue">
                            Continuer
