...
<body class="container">
  ...
  <div class="d-flex justify-content-center topSection-ctnr">
    <div class="fix-width">
      <div class="searchSection">
        ...
        <div>
          <span class="fs-36 border-accent color-grey-dark fs-34-r fs-22-r">Savoir</span><span
            class="fs-36 color-accent fs-34-r fs-22-r">
            Plus
        ...
        <div>
          ...
          <div class="text-center">
            <select name="" id="" class="selectSearch mr-10">
              <option class="placeHolder" value="" disabled selected hidden>Profession...</option>
            ...
            <input type="submit" value="Trouver" class="findBtn fs-24 font-weight-bold" />
          </div>
          <!-- end search -->
      ...
      <div class="flex-wrap fix-width Brikoleurs_premium2">
        <div class="sm-container sm-container-200 mr-10 ml-10 mb-20 mr-10-r ml-10-r mb-20-r">
          <img class="img-s180 mb-10 img-s152-r" src="images/testimg.jpg" alt="name of bk1" />
      ...
      <div class="explorer-grandparent">
        <div class="explorer-parent">
          ...
          <div class="float-right d-flex justify-content-between slideIndicator-ctnr mt-7"></div>
        </div>
      </div>
    ...
    <div class="flex-wrap fix-width Brikoleurs_premium1">
      <div class="sm-container sm-container-200 ml-20 mb-20">
        <img class="img-s180 mb-10" src="images/testimg.jpg" alt="name of bk1" />
  ...
  <div class="whyBrikole2 flex-column align-items-center">
    ...
    <div class="d-flex flex-wrap justify-content-center whyBrikole-ctnr">
      <div class="d-flex flex-column align-items-center sm-container whyBrikole-item">
        <div
  ...
  <div class="recRechSlide-parent">
    ...
    <div class="d-flex justify-content-between recRechSlide">
      <div class="sm-container2">
        ...
        <div class="d-flex align-items-center">
          <img class="rounded-circle img-s50" src="images/testimg.jpg" alt="" />
          <div>
    ...
    <div class="progress float-right progress-cstm">
      <div class="progress-bar progress-bar-cstm" role="progressbar" style="width: 25%;" aria-valuenow="25"
